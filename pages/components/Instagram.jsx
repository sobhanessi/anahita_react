        ...
        <Grid item sm={10} md={8}>
          ...
          >
            <div style={{ padding: "16px" }}>
              {" "}
              <a
                href="https://www.instagram.com/p/CeEPy65qmQY/?utm_source=ig_embed&utm_campaign=loading"
                style={{
                  background: "#FFFFFF",
                  lineHeight: 0,
                  padding: "0 0",
              ...
              >
                <a
                  ...
                  // target="_blank"
                >
                  A post shared by Anahita Persian Restaurant
                  (@anahita_persian_restaurant)
                </a>
              </p>
            </div>
          </blockquote>
